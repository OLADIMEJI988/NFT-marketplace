...
export default function TrendCollection() {
  return (
    <div className='bg-[#2B2B2B] text-start text-white sans py-10'>
      <div className='px-20'>
        <p className='text-3xl tracking-[-0.04em]'>Trending Collection</p>
        <p className='font-light text-sm mt-2 tracking-wide'>Checkout our weekly updated trending collection.</p>
      </div>

        <div className='flex gap-5 mt-9 px-44 justify-center'>
        <Collection 
            mainImg={dog}
            priImg={bunny}
            secImg={bear}
