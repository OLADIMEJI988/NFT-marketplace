    ...
    <header className="bg-[#2B2B2B] text-white py-4 px-6 sm:px-10">
          <div className="flex items-center justify-between">
             <Link to="/">
              ...
              <div className="sm:hidden pb-5 flex items-center mt-5">
                <button
            ...
            <nav
              ...
              } absolute sm:static top-14 left-0 w-full sm:w-auto bg-[#2B2B2B] sm:bg-transparent flex-col py-5 sm:flex-row sm:flex items-center gap-7 sm:gap-9 text-[13px] z-50 px-6 sm:px-0 py-8 sm:py-0`}
            >
              ...
              >
                ...
                <p className="-mt-[2px]">{username ? username : 'Sign Up'}</p>
              </button>
            </nav>
          </div>
        </header>
